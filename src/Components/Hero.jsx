...
const Hero = () => {
    return (
        <div>
            ...
            <div className='p-10 bg-linear-to-l from-[#632EE3] to-[#9F62F2] text-center text-white'>
                ...
                <div className='flex flex-col md:flex-row items-center justify-center gap-10 md:gap-14 mt-8'>
                    <div className='space-y-3'>
                        <p className='opacity-70 font-light'>Total Downloads</p>
                        <p className='font-bold text-5xl'>29.6M</p>
                        <p className='opacity-70 font-light'>21% more than last month</p>
                    </div>
                    <div className='space-y-3'>
                        <p className='opacity-70 font-light'>Total Reviews</p>
                        <p className='font-bold text-5xl'>906K</p>
                        <p className='opacity-70 font-light'>46% more than last month</p>
                    </div>
                    <div className='space-y-3'>
                        <p className='opacity-70 font-light'>Active Apps</p>
                        <p className='font-bold text-5xl'>132+</p>
                        <p className='opacity-70 font-light'>31 more will Launch</p>
                    </div>
                </div>
            </div>
        </div>
